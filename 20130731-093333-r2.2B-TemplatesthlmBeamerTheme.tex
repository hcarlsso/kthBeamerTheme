...
\begin{enumerate}
	...
	\begin{enumerate}
		\item \quoted{Flama-Light}
		\item \quoted{Flama-Book}
		\item \quoted{Flama-Medium}
	\end{enumerate}
\end{enumerate}
...
\begin{frame}{Images with Copyright}
	\begin{figure}
		\centering
		%\includegraphicscopyright[width=\linewidth]{../0-Images/IBDiplomaModel}{Copyright by \href{http://netzlemming.deviantart.com/}{Netzlemming}, \href{http://creativecommons.org/licenses/by-nc/3.0/}{CC BY-NC 3.0 License}}
	\end{figure}
\end{frame}
...
\begin{itemize}
	\item[] \quoted{This text has been quoted}
	\item[] \doublequoted{This text has been double quoted}
\end{itemize}
\end{frame}
